设计师给的是物理像素。我们写代码时用设备独立像素来布局（这就是为什么设计师给的设计稿给的大小和我们实际编写大小不一致的原因）
如何解决1px问题
为了适配各种屏幕，我们写代码时一般使用设备独立像素来对页面进行布局。而在设备像素比大于1的屏幕上，我们写的1px实际上是被多个物理像素渲染，
...
然后只需要将UI出的图转换为rem即可。以iPhone6为例：布局视口为375px，则1rem = 37.5px，这时UI给定一个元素的宽为75px，
